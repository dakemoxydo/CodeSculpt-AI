...
details = [
    ...
    ("turret-canister-gloss", "gloss", "dark-metal", "lower-roughness cylindrical side canisters", "front-three-quarter", 0.82),
    ...
    ("suspension-rods", "ridge", "suspension_rods", "paired exposed actuator/suspension rods", "front-three-quarter", 0.88),
...
components = [
    ...
    comp("turret_shell", "Rotating turret shell", "macro", "extrude", "armor", (4.2, 1.25, 3.5), parent="hull_shell", role="turret", features=["turret-bevel", "turret-ring", "sensor-cluster"], position=(0, 1.48, -0.18), detachable=True, evidence=["front-three-quarter", "top-view", "frontal-view"]),
    comp("main_barrel", "Main stepped barrel", "macro", "cylinder", "dark-metal", (0.36, 0.36, 6.6), parent="turret_shell", role="barrel", features=["barrel-rings", "muzzle-bore"], position=(0, 1.43, -4.2), detachable=True, evidence=["front-three-quarter", "side-view", "frontal-view"]),
    ...
    comp("deck_vents", "Deck vent fields", "micro", "box", "dark-metal", (1.6, 0.12, 0.8), parent="engine_deck", role="panel", features=["roof-vent-linework"], position=(0, 1.47, 2.05), evidence=["top-view", "rear-three-quarter"]),
    ...
    comp("front_track_fenders", "Front track fender blocks", "meso", "box", "armor", (1.1, 0.62, 1.2), parent="hull_shell", role="fender", features=["fender-chamfer", "front-corner-armor"], position=(-3.35, 0.18, -1.95), detachable=True, evidence=["front-three-quarter", "frontal-view"]),
    comp("rear_engine_armor", "Rear engine armor blocks", "meso", "box", "armor", (1.2, 0.62, 1.0), parent="hull_shell", role="armor-block", features=["rear-corner-armor", "engine-deck-edge"], position=(3.15, 0.24, 1.95), detachable=True, evidence=["rear-three-quarter", "top-view"]),
    comp("smoke_launcher_pods", "Smoke launcher pods", "meso", "cylinder", "dark-metal", (0.18, 0.38, 0.9), parent="turret_shell", role="launcher", features=["launcher-pods"], position=(-1.55, 1.6, 0.15), detachable=True, evidence=["front-three-quarter", "rear-three-quarter"]),
    comp("rear_port_modules", "Rear port modules", "meso", "box", "dark-metal", (3.0, 0.5, 0.35), parent="engine_deck", role="panel", features=["rear-port-modules"], position=(0, 1.18, 2.9), evidence=["rear-three-quarter", "top-view"]),
]
spec["componentTree"] = components

map_paths = {
    "albedo": {"path": ".img2threejs/pbr-evidence/painted-metal_albedo.png", "channel": "albedo"},
    "roughness": {"path": ".img2threejs/pbr-evidence/painted-metal_roughness.png", "channel": "roughness"},
    "height": {"path": ".img2threejs/pbr-evidence/painted-metal_height.png", "channel": "height"},
    "normal": {"path": ".img2threejs/pbr-evidence/painted-metal_normal.png", "channel": "normal"},
    "ao": {"path": ".img2threejs/pbr-evidence/painted-metal_ao.png", "channel": "ao"},
}
